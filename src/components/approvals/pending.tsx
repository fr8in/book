      ...
      render: (text, record) => (
        <Space>
          ...
          <Tooltip title='Accept'>
            <Button type='primary' shape='circle' size='small' className='btn-success' icon={<CheckOutlined />} />
          </Tooltip>
          <Tooltip title='Decline'>
            <Button type='primary' shape='circle' size='small' danger icon={<CloseOutlined />} />
          </Tooltip>
        </Space>
      )
    }
