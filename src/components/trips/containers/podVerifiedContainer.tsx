...
const PodVerifiedContainer = () => {
    ...
    const { loading, error, data } = useQuery(
      ...
      console.log('PodVerifiedContainer error', error)
      var trip = []
      var trip_status = []
      var pod_verified = []
      if (!loading) {
      ...
      const record_count =
      pod_verified.aggregate && pod_verified.aggregate.count;
...
export default PodVerifiedContainer
