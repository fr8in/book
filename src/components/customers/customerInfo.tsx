  ...
  return (
    <>
      <Row gutter={8}>
        ...
        <LabelAndData
          label='Exception'
          data={<CustomerExceptionDate exceptionDate={customer_info.exception_date} cardcode={customer_info.cardcode}  customer_id={customer_info.id} edit_access={exceptionDateEdit}/>}
          mdSpan={4}
          smSpan={8}
          xsSpan={12}
        />
